	...
	return (
		<div className="page-container">
			...
			<div className="content-box">
				...
				>
					...
					<div className="map">
						<iframe
							...
							title="Map showing Almond River Records location"
							allowFullScreen
							loading="lazy"
						></iframe>
						<p>
				...
				{/* Section 2: Opening Hours + Availability */}
				<section
					className="two-column-layout"
					aria-labelledby="availability-heading"
				>
					<div className="opening-hours-container">
						<h3 id="availability-heading">Shop Opening Hours</h3>
					...
					<div className="text-content">
						...
						<p>
							<em>
								...
								attachment to them. There are different things that you
								get hold of and they mean something to you. Whether it
								is the music itself or the artwork that comes with it.“
							</em>
						</p>
						<p>
							Almond River Records started as an online record shop on
							Christmas Eve 2020, and expanded to open a physical shop in
						...
						<p>
							...
							album or a more expensive collector item.
						</p>
					</div>
