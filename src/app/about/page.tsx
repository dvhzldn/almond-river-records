				...
				<div className="about">
					<div className="two-column-layout">
						<div className="text-content">
							...
							<p>
								Almond River Records shop is located in Corstorphine to
							...
							<p>
								...
								collection of records, CDs, books - and we offer a{" "}
								<Link href="/record-cleaning">
					...
					<div className="two-column-layout">
						...
						<div className="text-content">
							...
							<p>
								For any urgent enquiries or to discuss the sale of your
								records to us, please call Andy on{" "}
								<a
					...
					<div className="two-column-layout">
						<div className="text-content">
							...
							<p>
								...
								<em>
									There are different things that you get hold of and
									they mean something to you. Whether it is the music
									itself or the art work that comes with it.“
								</em>
							</p>
							<p>
								{" "}
								Almond River Records started as an online record shop on
								Christmas Eve 2020, but expanded to open a physical shop
								in December 2021 after a unit became available during
								lockdown.
							</p>
							<p>
								We hope to create an environment that is welcoming for
								all record lovers - with customers able to leave with a
								£5 album or a more expensive collector style item.
							</p>
						</div>
